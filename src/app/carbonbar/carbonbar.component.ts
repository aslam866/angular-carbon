...
@Component({
  ...
  templateUrl: './carbonbar.component.html',
  styleUrls: ['./carbonbar.component.css']
})
export class CarbonbarComponent implements OnInit,AfterContentInit {

  constructor(private elRef:ElementRef) {
     console.log("Dom reference for current component",elRef);
   }
